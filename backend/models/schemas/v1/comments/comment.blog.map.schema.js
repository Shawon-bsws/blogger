...
const dictionary = require('./comment.blog.map.dictionary.json');
...
Object.keys(fieldDefs).forEach((fieldName) => {
  if (fieldDefs[fieldName].db_fields) {
    ...
    if (fieldName === 'blog_comment_map_id') {
...
const CommentsBlogMap = Connection.define(
  'blog_comment_maps',
  sequelizeFields,
  {
    collate: 'en_US',
...
module.exports = CommentsBlogMap;
